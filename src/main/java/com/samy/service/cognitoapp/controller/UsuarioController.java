...
public class UsuarioController {
  ...
  public ColaboradorAdminReponse agregarAccesos(
      @Valid @RequestBody ColaboradorAccesoRequest request) {
    return colaboradorService.agregarAccesos(request);
  }

  @PutMapping(path = "/updateStatusColaborator")
  public ColaboradorAdminReponse updateStatusColaborator(
      @Valid @RequestBody ColaboradorDisableEnablaRequest request) {
    return colaboradorService.cambiarEstado(request);
  }

  @GetMapping(path = "/findByEmpresa/{empresa}")
  public UsuariosPorEmpresaResponse verPorEmpresa(@PathVariable String empresa) {
    return usuarioService.verPorEmpresa(empresa);
  }
}
